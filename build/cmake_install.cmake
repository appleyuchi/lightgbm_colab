# Install script for directory: /content/LightGBM
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/content/LightGBM/lightgbm")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/lightgbm" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/lightgbm")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/lightgbm"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/content/LightGBM/lib_lightgbm.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/lib_lightgbm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/lib_lightgbm.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/lib_lightgbm.so"
...
file(INSTALL DESTINATION "/usr/local/include" TYPE DIRECTORY FILES "/content/LightGBM/include/LightGBM")
endif()
...
file(WRITE "/content/LightGBM/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
